...
namespace lox::ast {
    ...
    private:
        ...
        using InfixParseFn = std::function<std::expected<ExprPtr, std::string>(ExprPtr)>;
        ...
        auto parse_expression_with_precedence(Precedence precedence) noexcept -> std::expected<ExprPtr, std::string>;
        ...
        auto parse_function_declaration() noexcept -> std::expected<StmtPtr, std::string>;
        auto parse_expression_statement() noexcept -> std::expected<StmtPtr, std::string>;
        ...
        auto parse_binary(ExprPtr left) noexcept -> std::expected<ExprPtr, std::string>;
